...
set(ANDROID_PASSTHROUGH_ARGS -DNCINE_ROOT=${NCINE_ROOT} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
	...
	-DDEATH_USE_RUNTIME_CAST=${DEATH_USE_RUNTIME_CAST} -DDEATH_CPU_USE_RUNTIME_DISPATCH=${DEATH_CPU_USE_RUNTIME_DISPATCH}
	...
	-DNCINE_WITH_BACKWARD=${NCINE_WITH_BACKWARD}
...
set(GRADLE_BUILDTOOLS_VERSION 36.0.0)
set(GRADLE_COMPILESDK_VERSION 35)
set(GRADLE_MINSDK_VERSION 21)
set(GRADLE_TARGETSDK_VERSION 35)
