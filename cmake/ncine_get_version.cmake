if(NCINE_VERSION_FROM_GIT)
	...
	if(GIT_EXECUTABLE AND IS_DIRECTORY ${CMAKE_SOURCE_DIR}/.git)
		...
		if(GIT_FAIL)
			message(STATUS "GIT failed with error ${GIT_FAIL}, cannot get current application version")
		...
		message(STATUS "GIT repository not found, cannot get current application version")
		set(GIT_NO_VERSION TRUE)
	endif()
else()
	set(GIT_NO_VERSION TRUE)
...
message(STATUS "Application version: ${NCINE_VERSION}")
